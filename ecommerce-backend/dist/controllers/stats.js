...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-stats"))
        ...
        const [thisMonthProducts, thisMonthUsers, thisMonthOrders, lastMonthProducts, lastMonthUsers, lastMonthOrders, productsCount, userCount, allOrders, lastSixMonthOrders, categories, femaleUserCount, latestTransection] = await Promise.all([
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const [processingOrder, ShippedOrder, deliveredOrder, categories, productsCount, productOutOfStock, allOrders, allUsers, adminUsers, customerUser] = await Promise.all([
